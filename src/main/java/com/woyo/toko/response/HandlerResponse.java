...
public class HandlerResponse {
    ...
    public static void responseBadRequest(HttpServletResponse response, int errorCode, String error){
        if (error.isEmpty()){
            error = "BAD REQUEST";
        }
    ...
    public static void responseNotFound(HttpServletResponse response, int errorCode, String error){
        if (error.isEmpty()){
            error = "NOT FOUND";
        }
